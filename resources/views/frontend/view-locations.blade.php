            ...
            <div class="restaurant-directory-cont-rt">
                ...
                <div class="container">
                    <div class="popular-locations-cont">
                        @foreach($locationListings as $city)
                        ...
                        <div class="trending-comp-slide">
                            ...
                            <div class="trend-slide-cont">
                                <div class="trend-inner-slide-cont">
                                    <p><img src="{{\App\Helpers\ImageHelper::imageUrl('Stack-grey.png') }}" alt="Stack">Restaurant</p>
                                    <a href="#">
                                        <h4 class="heading"><i class="fa-solid fa-tag"></i>{{ $offers->title }}</h4>
                                    </a>
